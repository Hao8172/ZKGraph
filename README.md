...
You can run any of the binaries defined in the `src/bin/` directory using Cargo, like
```sh
cargo run --bin ic1 --release
```

To run these binaries with different datasets, manually modify the relevant files in the src/bin/ directory. 
