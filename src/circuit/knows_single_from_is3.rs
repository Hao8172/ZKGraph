...
impl<F: Field + Ord> is3Chip<F> {
    ...
    pub fn assign(
        ...
        for relation_row in &person_knows_person {
            ...
            // 筛选出与 person_id_val 相关的关系
            if source_person_id_in_relation == person_id_val {
                // 在 person_table 中查找这位朋友的详细信息
