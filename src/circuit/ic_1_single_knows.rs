...
mod tests {
    ...
    fn test_is1_circuit() {
        ...
        let email_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/dynamic/person_email_emailaddress_0_0.csv",
            '|',
        )
        .expect("无法加载 eamil 数据");
        let language_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/dynamic/person_speaks_language_0_0.csv",
            '|',
        )
        .expect("无法加载 language 数据");
        let location_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/dynamic/person_isLocatedIn_place_0_0.csv",
            '|',
        )
        .expect("无法加载 location 数据");
        let place_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/static/place_0_0.csv",
            '|',
        )
        .expect("无法加载 place 数据");
        let studyat_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/dynamic/person_studyAt_organisation_0_0.csv",
            '|',
        )
        .expect("无法加载 study 数据");
        let workat_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/dynamic/person_workAt_organisation_0_0.csv",
            '|',
        )
        .expect("无法加载 work 数据");
        let organisation_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/static/organisation_0_0.csv",
            '|',
        )
        .expect("无法加载 organisation 数据");
        let org_location_data = read_csv(
            "/home/wh/zkgraph/src/data/sf0.1/social_network/static/organisation_isLocatedIn_place_0_0.csv",
            '|',
        ...
        let test_person_id: u64 = 933;
        let test_person_firstname = string_to_u64("Ian");
